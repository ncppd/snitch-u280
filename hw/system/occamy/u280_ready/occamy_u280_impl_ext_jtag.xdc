...
# This constraint file is written for u280 + FMC XM105 Debug Card and is included only when EXT_JTAG = 1

# 5 MHz max JTAG
create_clock -period 200 -name jtag_tck_i [get_pins occamy_u280_i/occamy/jtag_tck_i]
