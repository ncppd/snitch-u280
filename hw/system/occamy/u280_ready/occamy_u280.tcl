...
create_project $project ./$project -force -part xcu280-fsvh2892-2L-e
...
set_property used_in_synthesis false [get_files occamy_u280/occamy_u280.srcs/constrs_1/imports/u280_ready/occamy_u280_impl.xdc]
if { $EXT_JTAG } {
